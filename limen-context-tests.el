          ...
          (cl-letf (((symbol-function 'herdr-agent-session-p)
            ...
            (with-current-buffer dired-buffer
              ...
              (let ((text (cadar prompts)))
                (should (= (limen-context-tests--occurrences second text) 1))
                (should (= (limen-context-tests--occurrences first text) 1))
                (should (< (string-match (regexp-quote second) text)
                           (string-match (regexp-quote first) text)))
